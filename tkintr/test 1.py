...
var2=IntVar()
Checkbutton(root,text="regional", variable=var2).place(x=290,y=340)

def shitis():
    tkinter.messagebox.showinfo("Welcome to GFG.","SHIT IS CHUTIYA")

#this creates button for submitting the details provides by the user
Button(root, text='Submit' ,command=shitis(), width=20,bg="black",fg='white').place(x=180,y=380)
